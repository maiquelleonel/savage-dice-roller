...
function createSavageWorldsUIElement() {
  ...
  savageWorldsUI.innerHTML = `
      ...
      <div class="dice-buttons">
          <button data-die="d4" title="d4" class="die-button d4-color">
          ...
          <button data-die="d6" title="d6" class="die-button d6-color">
            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
          ...
          <button data-die="d8" title="d8" class="die-button d8-color">
            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
